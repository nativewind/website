---
title: Overview
description: Nativewind 4.2.7 is the stable release and uses Tailwind CSS v3.
---
...
✨ **Pseudo classes** hover / focus / active on compatible components [(docs)](/docs/core-concepts/states#hover-focus-and-active)
