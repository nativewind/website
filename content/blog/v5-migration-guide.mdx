...
---
> ⚠️ **Important:** Nativewind v5 is not yet available. This guide is to prepare people for the upgrade process.
...
> ⚠️ **Warning:** Deprecated features will continue to function in v5 but should be migrated away from as soon as possible.
