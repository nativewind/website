    ...
    <>
      ...
      <section className="relative flex flex-col w-full max-w-fd-container mx-auto -mt-[1px] border-y border-dashed">    
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 text-left">
          ...
          <UIKitCard url="https://rnr-docs.vercel.app/" title="React Native Reusables" preview="https://reactnativereusables.com/og.png" description="Build your own component libraries with react-native-reusables. Copy, paste, and tailor the code to suit your specific requirements." />
