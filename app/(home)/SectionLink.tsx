...
export default function SectionLink({href, name, border, className}: {href: string, name: string, border?: boolean, className?: string}) {
  return (
    <div className={cn(className, `sticky w-full max-w-fd-container top-14 mx-auto text-fd-muted-foreground/50 text-sm text-left font-mono ${ border && 'pl-1'} max-md:hidden`)}>
