  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 flex-wrap text-left gap-8 justify-around p-8 [mask:linear-gradient(to_right,transparent,red_1rem,red_calc(100%-1rem),transparent)] max-w-full">
      ...
      <div className="hidden sm:flex lg:hidden flex-col">
        {getColumnItems(0, 2).map((item) => (
          <ShowcaseItem key={item.name} {...item} />
        ))}
      </div>
      <div className="hidden sm:flex lg:hidden flex-col">
        {getColumnItems(1, 2).map((item) => (
          <ShowcaseItem key={item.name} {...item} />
        ))}
      </div>

      <div className="hidden lg:flex flex-col">
        {getColumnItems(0, 3).map((item) => (
          <ShowcaseItem key={item.name} {...item} />
        ))}
      </div>
      <div className="hidden lg:flex flex-col">
        {getColumnItems(1, 3).map((item) => (
          <ShowcaseItem key={item.name} {...item} />
        ))}
      </div>
      <div className="hidden lg:flex flex-col">
        {getColumnItems(2, 3).map((item) => (
          <ShowcaseItem key={item.name} {...item} />
        ))}
      </div>
    </div>
...
function getColumnItems(columnIndex: number, columnCount: number) {
  return items.filter((_, itemIndex) => itemIndex % columnCount === columnIndex);
}

// Brand snapshot: 8fedabcab4bb480b40a0d84002c12e32e03e6e23.
// The first six entries follow the showcase order requested for this revision.
// The remaining researched entries retain their verified order, followed by the
// earlier showcase entries restored from the preserved data.
const items: ShowcaseItemProps[] = [
  ...
  },
  {
    ...
    appstore:
      "https://apps.apple.com/us/app/wave-ai-note-taker/id6451491556",
  ...
  },
  {
    ...
    logo: SewaYouLogo,
    appstore:
      "https://apps.apple.com/us/app/sewayou-make-new-friends/id1455473510",
  ...
  },
  {
    ...
    appstore:
      "https://apps.apple.com/us/app/brainnotes-summarizer/id6744852497",
  },
  {
    name: "Reemi",
    ...
    logo: ReemiLogo,
    appstore:
      "https://apps.apple.com/us/app/reemi-social-reminders/id6742418635",
  },
  {
    name: "Swipey",
    description:
    ...
    appstore:
      "https://apps.apple.com/id/app/swipey-fin-os-for-modern-biz/id1589412706",
  },
  {
    name: "Knowhere",
    description:
  ...
  },
  {
    ...
    logo: AvocadoLogo,
    appstore:
      "https://apps.apple.com/us/app/avocado-calorie-goal-tracker/id6739069296",
  },
  {
    name: "DayStack",
    description:
  ...
  },
  {
    ...
    appstore:
      "https://apps.apple.com/us/app/ramble-van-travel-app/id6468265289",
    playstore:
  ...
  },
  {
    ...
    appstore:
      "https://apps.apple.com/fr/app/quiztr-fiche-de-r%C3%A9vision/id6503441928",
    playstore:
      "https://play.google.com/store/apps/details?id=com.quiztr.mobile.app",
  },
  {
    name: "Mylo",
    description:
    ...
    appstore:
      "https://apps.apple.com/se/app/mylo-avtal-och-dokument/id6733253272",
  ...
  },
  {
    ...
    appstore:
      "https://apps.apple.com/us/app/focusminny-stay-focused-ai/id6738607046",
  },
  {
    name: "BIC Group",
    description:
  ...
  },
  {
    ...
    appstore:
      "https://apps.apple.com/us/app/fluently-ai-english-tutor/id6683289805",
  },
  {
    name: "Shutter Mate",
    ...
    playstore:
      "https://play.google.com/store/apps/details?id=com.shuttermate.app",
  },
  {
    name: "GoTogether",
    description:
  ...
  },
  {
    ...
    appstore:
      "https://apps.apple.com/nl/app/ai-therapist-mindlumen/id6738006220",
  },
  {
    name: "Hivemind",
    ...
    appstore:
      "https://apps.apple.com/de/app/hivemind-study-by-scrolling/id6737344456",
  },
  {
    name: "VibeCode",
