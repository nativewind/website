...
export default function SectionTitle({ id, title, className } : { id: string; title: string, className?: string }) {
  return (
    <h1 id={id} className={cn('text-2xl md:text-4xl font-medium max-lg:px-8 pt-8 pb-4 md:pb-8 md:pt-12 border-t border-dashed backdrop-blur w-full dark:opacity-90 text-left', className)}>
