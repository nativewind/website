...
export default function SectionTitle({
  ...
  return (
    <Heading id={id} className={cn('text-2xl md:text-4xl font-medium max-lg:px-8 pt-8 pb-4 md:pt-12 border-b border-dashed backdrop-blur w-full dark:opacity-90 text-left', className)}>
