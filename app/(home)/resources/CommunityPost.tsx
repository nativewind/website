...
export default function CommunityPost({
  ...
  <div className="flex flex-col border-r border-dashed shrink-0 relative group/card">
    <div className="flex m-6 sm:m-2 rounded-2xl max-sm:shadow-xl hover:shadow-xl flex-col-reverse max-sm:bg-white max-sm:dark:bg-fd-muted hover:bg-white dark:hover:bg-fd-muted duration-300">
      <Link
        target="_blank"
        href={url}
