...
export default function StateOfNWCard({
  title,
  image,
  date,
  time,
    ...
    >
      <div className="relative mb-3 bg-black rounded-2xl border">
        <div className="absolute top-1/2 left-1/2 -translate-1/2 rounded-full bg-gradient-to-br from-fd-background to-fd-accent p-2 opacity-0 group-hover:opacity-100 scale-75 group-hover:scale-100 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] duration-300 z-10 overflow-clip">
          ...
          <Play className="fill-current translate-x-0.5 size-10 stroke-none text-fd-primary drop-shadow-2xl drop-shadow-fd-primary scale-75 delay-100 duration-300 group-hover:scale-100 ease-[cubic-bezier(0.175,0.885,0.33,1.275)]" />
        </div>
        <Image
          src={image}
          width={1280}
          height={720}
          alt="State of Nativewind Thumbnail"
          className="aspect-video h-auto w-76 rounded-2xl group-hover:opacity-50 transition-opacity duration-300 object-cover"
        />
