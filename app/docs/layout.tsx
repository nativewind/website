      ...
      sidebar={{
        ...
        banner: (
          <div className="flex flex-col gap-4">
            ...
            <Link href="/docs" className="text-sm mt-2 lg:hidden flex flex-row items-center gap-2 rounded-md p-2 text-start [overflow-wrap:anywhere] md:py-1.5 [&_svg]:size-4 [&_svg]:shrink-0 bg-fd-primary/10 text-fd-primary" style={{ paddingInlineStart: 'calc(var(--spacing) * 2)' }} >
              <BookOpen />
              Docs
            </Link>
          </div>
