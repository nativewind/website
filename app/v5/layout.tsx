      ...
      sidebar={{
        ...
        banner: (
          <div className="flex flex-col gap-4">
            <div className="flex flex-col lg:mb-2 gap-2 w-screen md:w-[var(--fd-sidebar-width)] -mx-4 bg-gradient-to-b from-amber-800/10 dark:from-amber-500/10 to-amber-500/50 backdrop-blur p-4 border-b border-dashed border-amber-500/50">
              ...
              <div className="flex justify-between flex-wrap gap-2">
                <Link
                  ...
                  className="relative flex bg-white/60 dark:bg-black/40 text-black/90 dark:text-white/90 w-fit flex-row items-center gap-2 rounded-md p-2 text-start [overflow-wrap:anywhere] md:py-1.5 [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-white/80 dark:hover:bg-black/80 duration-300"
            ...
            <Link href="/v5" className="text-sm mt-2 lg:hidden flex flex-row items-center gap-2 rounded-md p-2 text-start [overflow-wrap:anywhere] md:py-1.5 [&_svg]:size-4 [&_svg]:shrink-0 bg-amber-500/10 text-amber-600 dark:text-amber-500" style={{ paddingInlineStart: 'calc(var(--spacing) * 2)' }} >
              <BookOpen />
              Docs
            </Link>
          </div>
